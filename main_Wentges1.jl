...
println("\nDécomposition de Dantzig-Wolfe simple du Problème 1 avec stabilisation de Wentges : \n")
...
LB, obj, nb_col, X, Y, LBs, UBs = simple_decomposition_wentges(data,  wentges_coeff, time_limit)
